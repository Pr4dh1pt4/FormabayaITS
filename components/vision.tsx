                ...
                >
                    ...
                    >
                        <blockquote className="text-2xl md:text-4xl font-light italic text-white/80 max-w-4xl mx-auto leading-relaxed">
                            "Berjaya Bersama Tanah Para Raja"
                        </blockquote>
                ...
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <ul className="space-y-4 text-xl text-white/80">
                                {[
                                    'Menjadi wadah pertama, pemersatu, dan penggerak potensi mahasiswa Blitar Raya di ITS yang berdaya saing, berbudaya, serta aktif berkontribusi dalam kehidupan kampus dan masyarakat melalui semangat kemandirian, kolaborasi, dan keberlanjutan.'
                                ].map((item, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <ul className="space-y-4 text-xl text-white/80">
                                {[
                                    'Membangun solidaritas dan rasa kekerabatan antara mahasiswa ITS Blitar Raya',
                                    'Menjadi pusat informasi awal yang membantu mahasiswa baru memahami kehidupan kampus dan dunia luarnya',
                                    'Mendorong pencapaian dan pengembangan potensi anggota di bidang akademik, dan organisasi',
                                    'Menjadi jembatan komunikasi yang independen antara mahasiswa, dan instansi terkait'
                                ].map((item, index) => (
                                    <li key={index} className="flex items-start gap-3 group-hover:text-white transition-colors">
                                        <span className="w-1.5 h-1.5 rounded-full bg-[#CB6F4A] mt-2.5" />
                                        <span>{item}</span>
