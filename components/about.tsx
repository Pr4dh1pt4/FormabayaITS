                    ...
                    <div className="space-y-8">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    FORMABAYA ITS adalah singkatan dari Forum Mahasiswa Blitar Raya yang bertujuan menjadi wadah pertama bagi mahasiswa Institut Teknologi Sepuluh Nopember yang berasal dari Blitar Raya. 
                                </p>
                                <p>
                                    Selain menjadi wadah bagi mahasiswa, FORMABAYA juga membangun solidaritas dan rasa kekerabatan antara mahasiswa ITS Blitar Raya dan juga sharing informasi baik berupa kegiatan yang ada di dalam kampus dan hal-hal yang berkaitan diluar Institut Teknologi Sepuluh Nopember.

                                </p>
                            </div>

                            <div className="pt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {['Menjalin Relasi', 'Berbagi untuk Sesama', 'Bakti Sosial & Masyarakat', 'Wadah Inovasi'].map((item, i) => (
                                    <motion.div
                                        key={i}
